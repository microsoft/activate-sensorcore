...
namespace Steps
{
    ...
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private ActivateSensorCore.ActivateSensorCoreResult ActivationResults = new ActivateSensorCore.ActivateSensorCoreResult();
        ...
        {     
            // Pass the ActivationResult object to the ActivationPage
            ActivateSensorCore.Pages.ActivateSensorCore activateSensorCorePage = e.Content as ActivateSensorCore.Pages.ActivateSensorCore;
            if (activateSensorCorePage != null)
            {
                activateSensorCorePage.ActivationResult = ActivationResults;
                ActivationResults.Ongoing = true;
            }
        ...
        {
            if (ActivationResults.Ongoing)
            {
                ActivationResults.Ongoing = false;
                if (ActivationResults.ActivationRequestResult != ActivateSensorCore.ActivationRequestResults.AllEnabled)
                {
                    MessageBox.Show("This application doesn't work without the sensors. Application will be closed");
